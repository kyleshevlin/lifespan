...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _BirthdateFormContainer = __webpack_require__(55);
	...
	exports.composeWithDevTools = (
	  typeof window !== 'undefined' && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ ?
	    ...
	    function() {
	      ...
	      var compose = __webpack_require__(28).compose;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	for (var i = 1; i < _constants.WEEKS_IN_LIFE + 1; i++) {
	  initialWeeks.push({
	    id: i,
	    hasBeenLived: false,
	...
	var initialWeeksState = {
	  weeks: initialWeeks,
	  weeksLived: 0
	};

	var initialState = Object.assign({}, initialWeeksState, {
	  birthdate: '',
	  todayTime: new Date().getTime()
	});

	var handleBirthdateInput = function handleBirthdateInput(state, action) {
	  var birthdate = action.value;
	  var pattern = /^(0[1-9]|1[0-2])[/](0[1-9]|[12]\d|3[01])[/](19|20)\d{2}$/;
	  var weeksState = void 0;
	  ...
	  return _extends({}, state, weeksState, { birthdate: birthdate });
	};

	var updateWeeks = function updateWeeks(state, action) {
	  var birthdateTime = new Date(action.value).getTime();
	  var weeksLived = Math.floor((state.todayTime - birthdateTime) / (1000 * 3600 * 24 * 7));

	  if (weeksLived < 0) {
	    return initialWeeksState;
	  } else {
	    var newWeeks = state.weeks.map(function (week, index) {
	      var hasBeenLived = index < weeksLived;
	      return _extends({}, week, { hasBeenLived: hasBeenLived });
	    });

	    return { weeks: newWeeks, weeksLived: weeksLived };
	  }
	};
...
/***/ (function(module, exports) {
	...
	var BIRTHDATE_UPDATE = exports.BIRTHDATE_UPDATE = 'BIRTHDATE_UPDATE';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _BirthdateForm = __webpack_require__(57);
	...
	BirthdateFormContainer.propTypes = {
	  birthdate: _propTypes2.default.string,
	  weeksLived: _propTypes2.default.number,
	  birthdateUpdate: _propTypes2.default.func
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.birthdateUpdate = undefined;
	...
	var birthdateUpdate = exports.birthdateUpdate = function birthdateUpdate(value) {
	  return {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var weeksInflection = (0, _helpers.inflect)('week')('weeks');
	...
	var BirthdateForm = function BirthdateForm(_ref) {
	  ...
	  var til90 = _constants.WEEKS_IN_LIFE - weeksLived;
...
/***/ (function(module, exports) {
	...
	var inflect = exports.inflect = function inflect(singular) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Week = function Week(_ref) {
	  var decadeBirthday = _ref.decadeBirthday,
	      hasBeenLived = _ref.hasBeenLived;

	  var classes = (0, _classnames2.default)('week', { 'is-decade-birthday': decadeBirthday }, { 'has-been-lived': hasBeenLived });

	  return _react2.default.createElement('div', { className: classes });
	};

	Week.propTypes = {
	  decadeBirthday: _propTypes2.default.bool,
	  hasBeenLived: _propTypes2.default.bool
	};
